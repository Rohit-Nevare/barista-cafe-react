                    ...
                    <div className="row ">
                        {
                            props.feature.map(function (item) {
                                return (
                                    <div key={item.title} className="col-12 col-md-4">                                        <div>
                    ...
                    <div className="row">
                        <div className="col-12 products-tab mx-auto">
                            <ul className="nav nav-tabs flex-row ">
                                <li className="nav-item"><a data-bs-toggle="tab" href="#home" className="nav-link active">Toast</a></li>
                                <li className="nav-item"><a data-bs-toggle="tab" href="#about" className="nav-link">Pizza</a></li>
                        ...
                        <div className="col-12 col-md-6 col-lg-4 ps-lg-4">
...

                            {
                                props.footercon.map(function (fcon) {
                                    return (
                                        <div key={fcon.id || fcon.footerimg} className="d-flex justify-content-evenly align-items-center gap-2 pt-2">
                                            <div>
